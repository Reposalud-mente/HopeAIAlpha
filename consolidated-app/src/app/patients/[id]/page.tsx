    ...
    <AppLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-6 overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
          <div className="bg-gradient-to-r from-blue-50 via-slate-50 to-gray-50 p-1.5"></div>
          <div className="p-6">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="border-b border-gray-100 pb-3">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                    <h1 className="text-2xl font-bold text-gray-800">
                      ...
                      <span className="text-base font-normal text-gray-500 ml-2">({calculateAge(patient.dateOfBirth)} años)</span>
                    </h1>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-1">
                  <div className="flex items-center p-2.5 rounded-md hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          <TabsList className="mb-4 p-1 bg-gray-50 border border-gray-100 rounded-lg">
            <TabsTrigger value="info" className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-blue-700 transition-all duration-200">
              <UserCircle className="h-4 w-4 mr-2" />
              Información Personal
            </TabsTrigger>
            <TabsTrigger value="assessments" className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-blue-700 transition-all duration-200">
              <FileText className="h-4 w-4 mr-2" />
              Evaluaciones
            </TabsTrigger>
            <TabsTrigger value="sessions" className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-blue-700 transition-all duration-200">
          ...
          <TabsContent value="info">
            <div className="space-y-6">
              ...
              <Card className="border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                    ...
                    <div className="p-5">
                      <h3 className="text-sm font-medium text-gray-600 mb-4 flex items-center bg-gray-50 p-2 rounded-md">
                        <UserCircle className="h-4 w-4 text-blue-600 mr-2" />
                        Datos Personales
                      </h3>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-2 rounded-md border-b border-gray-50">
                    ...
                    <div className="p-5">
                      <h3 className="text-sm font-medium text-gray-600 mb-4 flex items-center bg-amber-50/50 p-2 rounded-md">
                        <AlertCircle className="h-4 w-4 text-amber-600 mr-2" />
                        Contacto de Emergencia
                      </h3>
                      <div className="space-y-3">
                        {patient.emergencyContactName || patient.emergencyContactPhone ? (
                          <div className="border border-amber-100 rounded-md p-3 bg-amber-50/30">
                            {patient.emergencyContactName && (
                              <div className="flex items-center mb-3">
                                <UserCircle className="h-5 w-5 text-amber-600 mr-2" />
                                <div>
                          ...
                          <div className="text-center py-6 border border-dashed border-gray-200 rounded-md">
                            ...
                            <p className="text-gray-500 text-sm">No se ha especificado un contacto de emergencia</p>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="p-5">
                      <h3 className="text-sm font-medium text-gray-600 mb-4 flex items-center bg-teal-50/50 p-2 rounded-md">
                      ...
                      <div className="space-y-4">
                        ...
                        {(patient.insuranceProvider || patient.insuranceNumber) && (
                          <div className="mt-5 pt-3 border border-indigo-100 rounded-md p-3 bg-indigo-50/30">
                            <div className="flex items-center mb-3">
              ...
              <Card className="border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-100 py-3">
                ...
                <CardContent className="p-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div className="flex items-center p-2 rounded-md hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
          ...
          <TabsContent value="assessments">
            <Card className="border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
              <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-100">
                <CardTitle className="text-lg flex items-center">
